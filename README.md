...
* `GLUEBUDDY_GITLAB_BOT_USERS` - Optionally set gitlab bot users (separated by commas)
* `GLUEBUDDY_GITLAB_SKIP_PATHS` - Optionally projects paths to skip in gitlab (separated by comma)
